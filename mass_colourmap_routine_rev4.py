...
def process_folder(input_folder, background_image_path, subtracted_folder, grayscale_folder, colormap_folder, crop_coords):
    """
...
if __name__ == "__main__":
    ...
    process_folder(input_folder, background_image_path, subtracted_folder, grayscale_folder, colormap_folder, crop_coords)
